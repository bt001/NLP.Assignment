...
# SBERT reconstruction function with debug
def sbert_reconstruct(text, threshold=0.5):
    ...
    for sent in sentences:
        ...
        print(f"   Score: {score:.3f}, Length ratio: {length_ratio:.2f}, Shared tokens: {shared_tokens}")
...
# Save output
output_path = "reconstructed_texts_pipeline1_sbert_pawswiki_debug.txt"
...
print("✅ SBERT + PAWS-Wiki (debug) pipeline complete. Output saved to:")
