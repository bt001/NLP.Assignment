...
# Save output
output_path = "reconstructed_texts_pipeline2_spacy_glove_rulebased_generalized_safe.txt"
...
print("✅ Generalized SpaCy rule-based pipeline (safe version) complete. Output saved to:")
